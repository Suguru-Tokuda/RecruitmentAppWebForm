<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtendOffer.aspx.cs" Inherits="RecruitmentAppWebForm.ExtendOffer" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <asp:Button ID="offerBtn" runat="server" OnClick="extendOfferClick" CssClass="btn btn-primary" Text="Extend Offer" />
        </div>
</asp:Content>
