...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <%--industry--%>
        <div class="form-group col-md-6">
            <label class="col-md-2 col-sm-2 col-xs-2">Industry</label>
        ...
        <div class="form-group">
            <asp:Button CssClass="btn btn-primary" runat="server" ID="registerCompanyBtn" OnClick="registerCompanyBtn_Click" />
        </div>
